...
public class TC077ElearningAdminMultipleUserRegistration {
	...
	public void validLoginTest() throws InterruptedException {
		...
		screenShot.captureScreenShot("ELTC077_Adminpage");
	}

	@Test(priority = 1, dataProvider = "excel-inputsadduser", dataProviderClass = LoginDataProviders.class)
	public void maddUserDetails(String firstName, String lastName, String email, String phone, String userName,
			String password, String role) throws InterruptedException {
		elearningadduserPOM.addUserLink();
		Thread.sleep(0500);
		screenShot.captureScreenShot("ELTC077_AddUserPage");
		...
		Thread.sleep(0500);
		screenShot.captureScreenShot("ELTC077_Welcomemessage");
	...
	public void maddUsertoCourse(String lletter, String lname, String fcourseletter, String scourse)
		...
		// driver.findElement(By.xpath("//option[contains(text(),'kachneria sandeep
		// (sandeep)')]")).isSelected();
		// driver.findElement(By.xpath("//option[contains(text(),'kachneria sandeep
		// (sandeep)')]")).click();
		...
		screenShot.captureScreenShot("ELTC077_Course Subscription message");
	}
